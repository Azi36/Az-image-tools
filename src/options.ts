...
const resizeMethods = ["fitWidth", "fitHeight", "scalePercent", "setShort", "setLong", "setCropRatio", "setCropSize", "presetCrop"] as const;
...
// Scale percentage: only shrinking makes sense for compression, cap at 100
...
export function normalizeCompressOption(value: unknown): CompressOption {
  ...
  return {
    ...
    resize: {
      ...
      percent: optionalPercent(resize.percent),
